...
export const candidates: Candidate[] = [
  {
    ...
    personalityAndHobbies: "성격: 긍정적 / 공감능력이 좋음 / 리액션 담당 / 취미: 여행, 방탈출, 영화",
  ...
  },
  {
    ...
    connectionDegree: "2촌",
    connectionLabel: "에나 친구의 친구",
    personalityAndHobbies: "성격 및 취미: 추가 확인 필요",
  ...
  },
  {
    ...
    connectionDegree: "2촌",
    connectionLabel: "에나 친구의 친구",
    personalityAndHobbies: "성격: 발랄함 / 유쾌함 / 털털함 / 취미: 게임, 야구관람",
    datingStyle: "편안한 관계, 친구처럼 티카타카 잘되는 스타일",
    preferredPartner: "대화 잘 통하는 사람, 잘나도 잘난척 하지 않는 사람",
    intro: "어른들한테는 귄있다(전라도 사투리), 친구들한테는 볼매다 라는 말을 많이 듣는편입니다. 밝고 잘 웃는 편이라 상대방이 조용하고 차분하거나 혹은 저랑 에너지가 비슷해도 다 잘 맞는편이에요😄",
  },
  {
    id: "A-04",
    birthYear: 1991,
    ...
    connectionDegree: "2촌",
    connectionLabel: "에나 친구의 친구",
    personalityAndHobbies: "성격: 경청 잘함 / 다정함 / 유쾌함 / 취미: 헬스, 카페, 여행",
  ...
  },
  {
    ...
    connectionDegree: "2촌",
    connectionLabel: "에나 친구의 친구",
    personalityAndHobbies: "성격: 유머 / 애교 / 뒤끝X / 취미: 여행, 운동",
  ...
  },
  {
    ...
    personalityAndHobbies: "성격: 다정한 / 발랄함 / 진중한 / 취미: 야구보기, 운동, 여행",
  ...
  },
  {
    ...
    connectionDegree: "1촌",
    connectionLabel: "에나 직접 지인",
    personalityAndHobbies: "성격: 재밌고 유쾌한 스타일 / 긍정적 / 추가 확인 필요 / 취미: 음악, 빠델, 술",
    datingStyle: "추가 확인 필요",
    preferredPartner: "긍정적인 여자분 + 흡연 무관한 분",
  ...
  },
  {
    ...
    connectionDegree: "1촌",
    connectionLabel: "에나 직접 지인",
    personalityAndHobbies: "성격: 추가 확인 필요 / 취미: 책읽기, 오케스트라",
    datingStyle: "추가 확인 필요",
